/*
 * SenchaCouch is a small JavaScript library containing the classes necessary for serving Ext JS
 * and Sencha Touch web applications and data from a common CouchDB server. This is ideal for
 * browser-based applications that need storage for JSON objects. CouchDB, along with the use of
 * CouchApp, also acts as the server for the application's static assets (JavaScript, CSS, HTML,
 * images, etc.).
 *
